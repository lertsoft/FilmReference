...
export const filmTranslations: Record<string, Record<Language, FilmTranslation>> = {
    kodak_gold_200: {
        ...
        es: {
            description: "La película de consumo cálida por excelencia. Conocida por sus tonos de hora dorada y sensación nostálgica.",
    ...
    kodak_ultramax_400: {
        ...
        es: {
            description: "Una película de consumo versátil y de alta saturación. Más vibrante que Portra pero con menos sesgo dorado que Gold 200.",
        ...
        fr: {
            description: "Une pellicule grand public polyvalente à haute saturation. Plus punchy que Portra mais avec moins de biais doré que Gold 200.",
    ...
    lomography_color_400: {
        ...
        es: {
            description: "Alto contraste y vibrante. A menudo se rumorea que es película Kodak reenvasada, pero muestra características distintas en los verdes.",
        ...
        fr: {
            description: "Contraste élevé et vibrant. Souvent rumeur d'être du stock Kodak reconditionnée, mais montre des caractéristiques distinctes dans les verts.",
    ...
    harman_phoenix_200: {
        ...
        es: {
            description: "Una película experimental con base única sin máscara. Contraste extremadamente alto y colores peculiares.",
    ...
    kodak_ektar_100: {
        ...
        es: {
            description: "La película negativa en color de grano más fino. Grado profesional con saturación similar a diapositivas.",
            overall_bias: "Saturación Extrema / Sombras Frías",
        ...
        fr: {
            ...
            overall_bias: "Saturation Extrême / Ombres Froides",
    ...
    kodak_portra_400: {
        ...
        es: {
            description: "El estándar de la industria para retrato profesional. Latitud excepcional y tonos de piel naturales.",
            overall_bias: "Natural / Prioridad Tonos de Piel",
            color_palette_notes: "El vectorscopio muestra la agrupación más ajustada alrededor del eje neutral para colores fríos, con extensión solo en el rango de tonos de piel (naranja).",
            best_for: ["Retratos", "Bodas", "Iluminación Mixta", "Viajes"]
        },
        fr: {
            description: "La référence de l'industrie pour le portrait professionnel. Latitude exceptionnelle et tons de peau naturels.",
            overall_bias: "Naturel / Priorité Tons Chair",
            color_palette_notes: "Le vectorscope montre le regroupement le plus serré autour de l'axe neutre pour les couleurs froides, avec extension uniquement dans la plage des tons chair (orange).",
    ...
    kodak_colorplus_200: {
        ...
        es: {
            ...
            best_for: ["Estilo Retro", "Sol Brillante", "Calle"]
        },
        fr: {
            ...
            best_for: ["Style Rétro", "Plein Soleil", "Rue"]
        }
    },
    fujifilm_200: {
        en: {
        ...
        es: {
            description: "En años recientes, fabricada en EE.UU. (probablemente Gold 200), pero las películas Fuji originales favorecen Magenta/Verde.",
        ...
        fr: {
            description: "Ces dernières années, fabriquée aux USA (probablement Gold 200), mais les stocks Fuji historiques favorisent Magenta/Vert.",
    ...
    cinestill_800t: {
        ...
        es: {
            description: "Película de cine con Remjet eliminado. Equilibrada para luz artificial (3200K).",
        ...
        fr: {
            description: "Pellicule cinéma avec Remjet retiré. Équilibrée pour lumière artificielle (3200K).",
    ...
    cinestill_50d: {
        ...
        es: {
            description: "Una película de cine equilibrada para luz de día. Famosa por su grano fino y efecto de halación específico debido a la eliminación de la capa Remjet.",
        ...
        fr: {
            description: "Une pellicule cinéma équilibrée lumière du jour. Célèbre pour son grain fin et son effet d'halation spécifique dû au retrait de la couche Remjet.",
    ...
    film_onehundred_100: {
        ...
        es: {
            description: "Una película única con personalidad 'complementaria dividida'. Probablemente Aerocolor IV, ofrece alto contraste y separación de colores muy distintiva.",
        ...
        fr: {
            description: "Une pellicule unique avec une personnalité 'complémentaire divisée'. Probablement Aerocolor IV, elle offre un contraste élevé et une séparation des couleurs très distincte.",
    ...
    kodak_pro_image_100: {
        ...
        es: {
            ...
            overall_bias: "Brillante / Desaturado (En Prueba de Video)",
        ...
        fr: {
            ...
            overall_bias: "Lumineux / Désaturé (En Test Vidéo)",
    ...
    lomochrome_color_92: {
        ...
        es: {
            description: "Una película diseñada para imitar la estética de las fotos instantáneas de los 90. Su estructura cristalina única resulta en un look retro y granulado.",
